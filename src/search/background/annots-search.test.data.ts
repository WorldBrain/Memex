...
export const ANNOTS: TestAnnot[] = [
    {
        ...
        uniqueAnnotationUrl: 'http://www.test.com/page0',
    ...
    },
    {
        ...
        title: 'Legitimacy',
        uniqueAnnotationUrl: 'http://www.test.com/page1',
    ...
    },
    {
        ...
        uniqueAnnotationUrl: 'http://www.test.com/page2#2',
    ...
    },
    {
        ...
        pageTitle: 'Divine right of kings',
        title: 'Divine right of kings',
        uniqueAnnotationUrl: 'http://www.test.com/page2#3',
        pageUrl: 'test.com/page2',
        tags: [TAG1, TAG2],
    },
    {
        ...
        pageTitle: 'Divine right of kings',
        title: 'Divine right of kings',
        uniqueAnnotationUrl: 'http://www.test.com/page2#4',
        pageUrl: 'test.com/page2',
        hasBookmark: true,
    },
    {
        ...
        uniqueAnnotationUrl: 'http://www.test.com/page5#asdf',
    ...
    },
    {
        ...
        pageTitle: 'Mandate of Heaven',
        title: 'Mandate of Heaven',
        uniqueAnnotationUrl: 'http://www.test.com/page5',
        pageUrl: 'test.com/page5',
        lists: [LIST1, LIST2],
    },
    {
        ...
        uniqueAnnotationUrl: 'http://www.test.com/page3#1',
    ...
    },
    {
        ...
        pageTitle: 'Sphere of influence',
        title: 'Sphere of influence',
        uniqueAnnotationUrl: 'http://www.test.com/page3#2',
        pageUrl: 'test.com/page3',
        hasBookmark: true,
    },
    {
        ...
        title: 'Warsaw Pact',
        uniqueAnnotationUrl: 'http://www.test.com/page7#1',
    ...
    },
    {
        ...
        pageTitle: 'Warsaw Pact',
        title: 'Warsaw Pact',
        uniqueAnnotationUrl: 'http://www.test.com/page7#2',
        pageUrl: 'test.com/page7',
    },
    {
        ...
        uniqueAnnotationUrl: 'http://www.test.com/page9#1',
    ...
    },
    {
        ...
        pageTitle: 'Collective defense',
        title: 'Collective defense',
        uniqueAnnotationUrl: 'http://www.test.com/page9#2',
        pageUrl: 'test.com/page9',
        hasBookmark: true,
        lists: [LIST1],
    },

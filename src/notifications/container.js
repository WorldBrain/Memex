    ...
    renderStatusHeading() {
        ...
        if (this.props.isLoadingBar) {
            ...
            return unreadNotificationList.length === 0 ? ( <
                NoNotification title = "No new notifications" > ¯\_(ツ) _ / ¯
                <
                /NoNotification>
            ) : null
        }
        ...
        return ( <
            NotificationList > {
                ...
                readNotificationList.length !== 0 && ( <
                    ReadHeader isReadExpanded = {
                        this.props.isReadExpanded
                    }
                    toggleReadExpand = {
                        this.props.toggleReadExpand
                    }
                    />
                )
            } {

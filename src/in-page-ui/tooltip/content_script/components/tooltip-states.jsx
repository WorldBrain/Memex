...
export const InitialComponent = ({
    ...
    <div className={styles.createButtons}>
        <div className={styles.button} onClick={createHighlight}>
            <ButtonTooltip tooltipText={<p><strong>Highlight</strong><br/>+ shift to share</p>} position="bottomHighlighter">
                <img src={highlighter} className={styles.buttonImg} />
            </ButtonTooltip>
        </div>

        <div className={styles.button} onClick={createAnnotation}>
            <ButtonTooltip tooltipText={<p><strong>Annotate</strong><br/>+ shift to share</p>} position="bottomHighlighter">
        ...
        >
            <ButtonTooltip
                tooltipText={<p><strong>Close Highlighter</strong><br/>Disable in Settings</p>}
                position="bottomHighlighter"
            >

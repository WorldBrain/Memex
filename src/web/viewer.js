    ...
    /******/ [
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            var PDFViewerApplication = {
                                        ...
                                        while (1) {
                                            switch (
                                                ...
                                                case 4:
                                                    ...
                                                    _context2.t0 = _regenerator2.default.keys(
                                                        prefs,
                                                    )
                        ...
                        if (
                            ...
                            if (_this5.pdfHistory.initialBookmark) {
                                _this5.initialBookmark =
                                    _this5.pdfHistory.initialBookmark
                                _this5.initialRotation =
                                    _this5.pdfHistory.initialRotation
                            }
                        }
                            ...
                            .then(
                                (function() {
                                    var _ref10 = _asyncToGenerator(
                                        /*#__PURE__*/ _regenerator2.default.mark(
                                            function _callee8(_ref9) {
                                                var _ref11 = _slicedToArray(
                                                        _ref9,
                                                        2,
                                                    ),
                                                    _ref11$ = _ref11[0],
                    ...
                    pdfDocument.getMetadata().then(function(_ref12) {
                        var info = _ref12.info,
                            ...
                            contentDispositionFilename =
                                _ref12.contentDispositionFilename
                ...
                setInitialView: function setInitialView(storedHash) {
                    ...
                    var setViewerModes = function setViewerModes(
                        scroll,
                        spread,
                    ) {
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            function formatL10nValue(text, args) {
                ...
                return text.replace(/\{\{\s*(\w+)\s*\}\}/g, function(
                    all,
                    name,
                ) {
                        ...
                        value: function dispatch(eventName) {
                            ...
                            if (
                                ...
                                if (this._dispatchToDOM) {
                                    var _args5 = Array.prototype.slice.call(
                                        arguments,
                                        1,
                                    )
                ...
                _createClass(PDFSidebar, [
                        ...
                        value: function switchView(view) {
                            ...
                            switch (view) {
                                case SidebarView.THUMBS:
                                    this.thumbnailButton.classList.add(
                                        'toggled',
                                    )
                                    ...
                                    this.thumbnailView.classList.remove(
                                        'hidden',
                                    )
                                ...
                                case SidebarView.ATTACHMENTS:
                                    ...
                                    this.thumbnailView.classList.add('hidden')
                                    this.outlineView.classList.add('hidden')
                                    this.attachmentsView.classList.remove(
                                        'hidden',
                                    )
                                    break
                                default:
                    ...
                    },
                    {
                        ...
                        value: function _addEventListeners() {
                            ...
                            this.eventBus.on('attachmentsloaded', function(
                                evt,
                            ) {
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            var defaultOptions = {
                ...
                disableCreateObjectURL: {
                    value:
                        _pdfjsLib.apiCompatibilityParams
                ...
                _createClass(PDFDocumentProperties, [
                    {
                        ...
                        value: function open() {
                            ...
                            var freezeFieldData = function freezeFieldData(
                                data,
                            ) {
                    ...
                    },
                    {
                        ...
                        value: function _updateUI() {
                            ...
                            if (
                                this.overlayManager.active !== this.overlayName
                            ) {
                                return
                            }
                    ...
                    },
                    {
                        ...
                        value: function _parsePageSize(
                            ...
                            var isPortrait = (0,
                            _ui_utils.isPortraitOrientation)(pageSizeInches)
                            var sizeInches = {
                                width:
                                    Math.round(pageSizeInches.width * 100) /
                                    100,
                                height:
                                    Math.round(pageSizeInches.height * 100) /
                                    100,
                            }
                            var sizeMillimeters = {
                                width:
                ...
                _createClass(PDFFindBar, [
                    ...
                    },
                    {
                        ...
                        value: function updateResultsCount() {
                            ...
                            var _ref =
                                ...
                                current =
                                    _ref$current === undefined
                                        ? 0
                                        : _ref$current,
                                _ref$total = _ref.total,
                                total =
                                    _ref$total === undefined ? 0 : _ref$total
                            ...
                            Promise.resolve(matchesCountMsg).then(function(
                                msg,
                            ) {
                                _this3.findResultsCount.textContent = msg
                                _this3.findResultsCount.classList[
                                    !total ? 'add' : 'remove'
                                ]('hidden')
                                _this3._adjustWidth()
                            })
                    ...
                    },
                    {
                        ...
                        value: function _adjustWidth() {
                            ...
                            var inputContainerHeight = this.bar
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            var PDFFindController = (function() {
                function PDFFindController(_ref) {
                    ...
                    this._normalizationRegex = new RegExp(
                        '[' + replace + ']',
                        'g',
                    )
                }
                ...
                _createClass(PDFFindController, [
                    ...
                    },
                    {
                        ...
                        value: function _calculateMatch(pageIndex) {
                            var pageContent = this._normalize(
                            ...
                            var pageMatchesCount = this._pageMatches[pageIndex]
                                .length
                    ...
                    },
                    {
                        ...
                        value: function _nextMatch() {
                            ...
                            if (offset.matchIdx !== null) {
                                var numPageMatches = this._pageMatches[
                                    offset.pageIdx
                                ].length
                                if (
                                    (!previous &&
        ...
        /***/ function(module, exports, __webpack_require__) {
                ...
                _createClass(PDFHistory, [
                    {
                        ...
                        value: function initialize(fingerprint) {
                            ...
                            if (!this._isValidState(state) || resetHistory) {
                                var _parseCurrentHash = parseCurrentHash(
                                        this.linkService,
                                    ),
                    ...
                    },
                    {
                        ...
                        value: function _popState(_ref4) {
                            ...
                            if (!state || false) {
                                ...
                                var _parseCurrentHash2 = parseCurrentHash(
                                        this.linkService,
                                    ),
            ...
            function isDestHashesEqual(destHash, pushHash) {
                ...
                var _parseQueryString = (0, _ui_utils.parseQueryString)(
                        destHash,
                    ),
            ...
            var PDFLinkService = (function() {
                function PDFLinkService() {
                    var _ref =
                        ...
                        externalLinkRel =
                            _ref$externalLinkRel === undefined
                                ? null
                    ...
                    },
                    {
                        ...
                        value: function setHash(hash) {
                            var pageNumber = void 0,
                                dest = void 0
                            if (hash.includes('=')) {
                                var params = (0, _ui_utils.parseQueryString)(
                                    hash,
                                )
                                if ('search' in params) {
                            ...
                            while (queue.length > 0) {
                                ...
                                for (
                                    ...
                                    if (item.items.length > 0) {
                                        ...
                                        var itemsDiv = document.createElement(
                                            'div',
                                        )
                ...
                _createClass(PDFSidebarResizer, [
                    ...
                    },
                    {
                        ...
                        value: function _addEventListeners() {
                            ...
                            this.resizer.addEventListener('mousedown', function(
                                evt,
                            ) {
                                if (evt.button !== 0) {
                                    return
                            ...
                            this.eventBus.on('sidebarviewchanged', function(
                                evt,
                            ) {
                                ...
                                if (evt && evt.source === window) {
                                    ...
                                    if (_this2._width) {
                                        if (_this2.sidebarOpen) {
                                            ...
                                            var updated = _this2._updateWidth(
                                                _this2._width,
                                            )
                                            Promise.resolve().then(function() {
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            value: function setImage(pageView) {
                                ...
                                var reducedImageCtx = reducedImage.getContext(
                                    '2d',
                                )
                                while (
            ...
            var PDFViewer = (function(_BaseViewer) {
                ...
                function PDFViewer() {
                    ...
                    return _possibleConstructorReturn(
                        ...
                        (
                            PDFViewer.__proto__ ||
                            Object.getPrototypeOf(PDFViewer)
                ...
                _createClass(PDFViewer, [
                    {
                        ...
                        value: function _scrollIntoView(_ref) {
                            ...
                            if (!pageSpot && !this.isInPresentationMode) {
                                ...
                                if (
                                    this._scrollMode ===
                                        _base_viewer.ScrollMode.HORIZONTAL ||
                                    left < scrollLeft ||
            ...
            function PDFPageViewBuffer(size) {
                ...
                this.resize = function(newSize, pagesToKeep) {
                    ...
                    if (pagesToKeep) {
                        ...
                        for (
                            var i = 0, iMax = pagesToKeep.length;
                            i < iMax;
                            ++i
                        ) {
            ...
            var BaseViewer = (function() {
                ...
                _createClass(BaseViewer, [
                        ...
                        value: function setDocument(pdfDocument) {
                            ...
                            firstPagePromise
                                .then(function(pdfPage) {
                                    ...
                                    if (
                                        _this2._spreadMode !== SpreadMode.NONE
                                    ) {
                    ...
                    },
                    {
                        ...
                        value: function _setScaleDispatchEvent(
                            newScale,
                            newValue,
                        ) {
                            var preset =
                    ...
                    },
                    {
                        ...
                        value: function _setScale(value) {
                            ...
                            if (scale > 0) {
                                ...
                                var hPadding = noPadding
                                    ? 0
                                    : _ui_utils.SCROLLBAR_PADDING
                                var vPadding = noPadding
                                    ? 0
                    ...
                    },
                    {
                        ...
                        get: function get() {
                            throw new Error(
                                'Not implemented: _isScrollModeHorizontal',
                            )
                        },
                    },
                    {
            ...
            var AnnotationLayerBuilder = (function() {
                function AnnotationLayerBuilder(_ref) {
                    var pageDiv = _ref.pageDiv,
                        ...
                        imageResourcesPath =
                            _ref$imageResourcesPa === undefined
                                ? ''
                ...
                _createClass(PDFPageView, [
                    ...
                    },
                    {
                        ...
                        value: function draw() {
                            ...
                            var finishPaintTask = function finishPaintTask(
                                error,
                            ) {
                    ...
                    },
                    {
                        ...
                        value: function renderMatches(matches) {
                            ...
                            function appendTextToDiv(
                                ...
                                var content = textContentItemsStr[
                                    divIdx
                    ...
                    },
                    {
                        ...
                        value: function updateMatches() {
                            ...
                            if (this.findController !== null) {
                                pageMatches =
                                    this.findController.pageMatches[
                                        this.pageIdx
                                    ] || null
                    ...
                    },
                    {
                        ...
                        value: function _bindScrollModeListener(buttons) {
                            ...
                            function scrollModeChanged(evt) {
                                buttons.scrollVerticalButton.classList.remove(
                                    'toggled',
                                )
                                buttons.scrollHorizontalButton.classList.remove(
                                    'toggled',
                                )
                                buttons.scrollWrappedButton.classList.remove(
                                    'toggled',
                                )
                                switch (evt.mode) {
                                    case _base_viewer.ScrollMode.VERTICAL:
                                        buttons.scrollVerticalButton.classList.add(
                                            'toggled',
                                        )
                                        break
                                    case _base_viewer.ScrollMode.HORIZONTAL:
                                        buttons.scrollHorizontalButton.classList.add(
                                            'toggled',
                                        )
                                        break
                                    case _base_viewer.ScrollMode.WRAPPED:
                                        buttons.scrollWrappedButton.classList.add(
                                            'toggled',
                                        )
                                        break
                                }
                            ...
                            this.eventBus.on('secondarytoolbarreset', function(
                                evt,
                            ) {
                    ...
                    },
                    {
                        ...
                        value: function _bindSpreadModeListener(buttons) {
                            ...
                            function spreadModeChanged(evt) {
                                buttons.spreadNoneButton.classList.remove(
                                    'toggled',
                                )
                                buttons.spreadOddButton.classList.remove(
                                    'toggled',
                                )
                                buttons.spreadEvenButton.classList.remove(
                                    'toggled',
                                )
                                switch (evt.mode) {
                                    case _base_viewer.SpreadMode.NONE:
                                        buttons.spreadNoneButton.classList.add(
                                            'toggled',
                                        )
                                        break
                                    case _base_viewer.SpreadMode.ODD:
                                        buttons.spreadOddButton.classList.add(
                                            'toggled',
                                        )
                                        break
                                    case _base_viewer.SpreadMode.EVEN:
                                        buttons.spreadEvenButton.classList.add(
                                            'toggled',
                                        )
                                        break
                                }
                    ...
                    },
                    {
                        ...
                        value: function _ensurePageViewVisible() {
                            ...
                            switch (viewerNodes.length) {
                                ...
                                case 1:
                                    if (
                                        viewerNodes[0] !== previousPageView.div
                                    ) {
                                        throw new Error(

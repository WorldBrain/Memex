        ...
        <div>
            <form className={Styles.form}>
                <label className={Styles.label}>
                    ...
                    <span style={{ cursor: 'pointer' }}>
                        ...
                        <p className={Styles.description}>
                            Backup your data to your hard drive, or to any cloud
                            provider with a syncing folder on your computer
                ...
                <label className={Styles.label}>
                    ...
                    <p className={Styles.description}>
                        Make sure you are trying to backup your data to the same
                        Google Account than the one logged into your browser
                        profile.
                    </p>
                </label>
                <br />

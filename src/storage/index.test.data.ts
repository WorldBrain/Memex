...
export const EXPECTED_SCHEMA_CHROME = [
    {
        schema: {
    ...
    },
    {
        schema: {
            ...
            favIcons: 'hostname',
            tags: '[name+url], name, url',
            directLinks: 'url, *_body_terms, *_pageTitle_terms, createdWhen',
        },
    ...
    },
    {
        schema: {
            ...
            tags: '[name+url], name, url',
            directLinks: 'url, *_body_terms, *_pageTitle_terms, createdWhen',
            customLists: 'id, &name, createdAt, isDeletable, isNestable',
    ...
    },
    {
        schema: {
            ...
            annotListEntries: '[listId+url], listId, url',
            annotBookmarks: 'url, createdAt',
            socialPosts: '++id, *_text_terms, createdAt, serviceId, userId',
    ...
    },
    {
        schema: {
            ...
            directLinks:
                'url, *_body_terms, *_comment_terms, *_pageTitle_terms, createdWhen, pageUrl',
            customLists: 'id, createdAt, isDeletable, isNestable, name',
            pageListEntries: '[listId+pageUrl], listId, pageUrl',
            eventLog: '[time+type], time, type',
            notifications: 'id',
            annotations:
...
export const EXPECTED_SCHEMA_FF = [
    ...EXPECTED_SCHEMA_CHROME.slice(0, 17),
    {
        schema: {
            pages: 'url, *terms, *titleTerms, *urlTerms, domain, hostname',
            visits: '[time+url], url',
    ...
    // Duplicate entry, due to bug with schemas
    {
        schema: {
            pages: 'url, *terms, *titleTerms, *urlTerms, domain, hostname',
            visits: '[time+url], url',

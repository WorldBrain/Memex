...
export const comment = browser.runtime.getURL('/img/peoplePlusFine.svg')
export const plusIcon = browser.runtime.getURL('/img/peoplePlusFine.svg')
export const people = browser.runtime.getURL('/img/peoplePlusFine.svg')

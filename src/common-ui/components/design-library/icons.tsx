...
export const boldIcon = browser.runtime.getURL('/img/file-pdf.svg')
export const italicIcon = browser.runtime.getURL('/img/file-pdf.svg')
export const h1Icon = browser.runtime.getURL('/img/file-pdf.svg')
export const h2Icon = browser.runtime.getURL('/img/file-pdf.svg')
export const imageIcon = browser.runtime.getURL('/img/file-pdf.svg')
export const timestampIcon = browser.runtime.getURL('/img/file-pdf.svg')
export const numberedListIcon = browser.runtime.getURL('/img/file-pdf.svg')
export const bulletListIcon = browser.runtime.getURL('/img/file-pdf.svg')
export const strikethroughIcon = browser.runtime.getURL('/img/file-pdf.svg')
